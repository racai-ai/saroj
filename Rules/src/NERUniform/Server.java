...
import rules.RulesProcessor;
import uniform.UniformProcessor;
...
public class Server {
	...
	public static void help() {
		System.out.println("NERUniform.Server PORT\n");
		System.out.println("MINW = minimum number of words for uniform annotation");
    ...
    public static void main(String[] args) throws IOException {
    	...
    	int minw=Integer.parseInt(args[0]);
    	int port=Integer.parseInt(args[1]);
    	
        System.out.println("Starting server on port "+port);
		HttpServer server = HttpServer.create(new InetSocketAddress("127.0.0.1",port),0);
        server.createContext("/checkHealth", new CheckHealthHandler(null));
        server.createContext("/process", new ProcessHandler(null,minw));
    ...
    static class ProcessHandler extends CoreHandler {
		...
		public ProcessHandler(String base_log_path,int minw) {
			super(base_log_path);
			this.minw=minw;
		}
		...
		public String getResult(JSONObject jsonData, String jsonStr) throws JSONException, IOException {
			...
			CONLLUPWriter out=new CONLLUPWriter(Paths.get(output), new ArrayList<String>(), new ArrayList<String>(), new ArrayList<String>());
			
			UniformProcessor proc=new UniformProcessor(minw);
